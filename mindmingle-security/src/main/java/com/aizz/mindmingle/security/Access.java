...
import com.aizz.mindmingle.domain.dto.AccessUser;
...
public class Access {
    ...
    public TreeMap<String, Object> requestParam;
    ...
    public void setRequestParam(TreeMap<String, Object> requestParam) { this.requestParam = requestParam; }
